...
fn test_scan_integer() {
    ...
    let expected_tokens: Vec<Token> = vec![Token {
        line_number: 1,
...
fn test_multiple_let_statements() {
    ...
    let expected_tokens: Vec<Token> = vec![
        ...
        Token {
            line_number: 2,
            token: TokenType::Identifier("y".to_string()),
        },
        Token {
            line_number: 2,
            token: TokenType::Colon,
        ...
        Token {
            line_number: 2,
            token: TokenType::Keyword(Keyword::Float),
        },
        Token {
            line_number: 2,
            token: TokenType::Equal,
